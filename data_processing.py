...
def processing(input_path, output_path):
    ...
    df_estab['cnpj_basico'] = df_estab[['cnpj_basico', 'cnpj_ordem', 'cnpj_dv']].astype(str).apply(''.join, axis=1)
    df_estab = df_estab.drop(['cnpj_ordem', 'cnpj_dv'], axis=1).rename(columns={'cnpj_basico': 'cnpj'})
